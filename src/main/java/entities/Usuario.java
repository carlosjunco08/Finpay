...
public class Usuario implements Serializable {
    ...
    @NotNull
    @Size(min = 1, max = 100)
    @Column(name = "contrasena")  // ⚡ en la BD sigue con ñ
    private String contrasena;     // ⚡ en Java sin ñ
    ...
    public Usuario(Integer idusuario, String nombres, String apellidos, String identificacion, String correo,
                   String telefono, String direccion, String contrasena, String nombreUsuario) {
        this.idusuario = idusuario;
